...
module.exports = async (draft, { lib }) => {
  ...
  const getData = (type, prop) => {
    ...
    try {
      switch (type) {
        ...
        case "Description":
          return prop.Description._value_1.substring(0, 40);
        case "PostalAddress":
          return [
            [
  ...
  for (let idx = 0; idx < ci.length; idx++) {
    ...
    const fileHeader = {
      ...
      FileGenNbr: invoice.ID._value_1,
      FileVerNbr,
      FileCreateDate,
    };
    ...
    if (buyerID === "C3001" || buyerID === "C1005") {
      ...
      const BuyerAddrArr = getData("PostalAddress", buyer);
      fileHeader.CustomerAddr1 = BuyerAddrArr[0];
      fileHeader.CustomerAddr2 = BuyerAddrArr[1];
      fileHeader.CustomerAddr3 = BuyerAddrArr[2];
      fileHeader.CustomerAddr4 = BuyerAddrArr[3] || " ";
