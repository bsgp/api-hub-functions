module.exports = async (draft, { sql }) => {
  ...
  const result = await mysql.table
    .create("ftdb_test", function (table) {
      table.charset("utf8mb4");
      table.string("TEST_DEFECT").notNullable();
      table.string("TEST_GS3A").defaultTo("");
      table.string("TEST_GS3B").defaultTo("");
      table.string("TEST_GS4A").defaultTo("");
      table.string("TEST_GS4B").defaultTo("");
    })
    .run();
